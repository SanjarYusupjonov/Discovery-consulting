...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <form class="card-body" action="{{route('news.update',$new->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <textarea class="w-100" name="text">{{$new->text}}</textarea>
            </div>
          </div>
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <div id="image-preview" class="image-preview">
                ...
                <input type="file" name="img" id="image-upload" value="{{$new->img}}"/>
              </div>
            </div>
          </div>
          <div class="form-group row mb-4">
